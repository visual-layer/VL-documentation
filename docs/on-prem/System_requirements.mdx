...
description: "Hardware, software, and configuration requirements for installing Visual Layer on-premises including GPU setup and dependencies."
---
...
- CPU: 16 cores.
- Optional: GPU: Common Nvidia GPU types with **at least** than 24GB of GPU memory (Nvidia A10, A100, H100, RTX 4090, etc.).
