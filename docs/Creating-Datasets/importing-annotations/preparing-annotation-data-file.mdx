...
To convert YOLO annotation to VL format visit: [Converting YOLO Annotations to Visual Layer Format](/docs/Creating-Datasets/importing-annotations/converting-yolo)
...
For instructions on importing annotation files, see [Importing Annotations.](/docs/Creating-Datasets/importing-annotations/annotations-overview-new#annotation)
