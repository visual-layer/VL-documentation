...
Since this is an example script for demonstration purposes, you can copy the complete script code below:

<details>
<summary>📄 **custom_metadata_upload_example.py** - Click to expand full script</summary>
...
Usage:
    python custom_metadata_upload_example.py metadata.csv metadata.json \
        --dataset-id=your-dataset-id --base-url=http://localhost:2080
"""
...
Examples:
  ...
  python custom_metadata_upload_example.py data.csv export.json \\
    --dataset-id=my-dataset --base-url=http://visual-layer:3000
...
**To use this script:**
1. Copy the code above and save it as `custom_metadata_upload_example.py`
...
- [Dataset Management](/docs/Managing-Datasets/save-views) - Working with metadata in the Visual Layer UI