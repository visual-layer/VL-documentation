...
<CardGroup cols={2}>
  <Card title="Custom Metadata API Guide" icon="file-braces-corner" href="/docs/Creating-Datasets/custom-metadata">
    Manual API workflow and field type details
  </Card>
  <Card title="DICOM Converter" icon="file-braces-corner" href="/docs/Creating-Datasets/dicom-converter">
    Specialized workflow for medical imaging metadata
  </Card>
  <Card title="Creating Datasets" icon="database" href="/docs/quick-start/tutorial-create-dataset">
    Guide to creating Visual Layer datasets
  </Card>
</CardGroup>