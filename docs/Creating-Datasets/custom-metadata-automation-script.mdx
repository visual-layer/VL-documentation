...
- `enum` - Categorical data (up to 100 unique values)
- `multi-enum` - Array fields with multiple values
- `link` - URLs with protocols (http://, https://, ftp://)
...
- `float` - Decimal numbers
- `datetime` - Date/time values
- `enum` - Single categorical value
- `multi-enum` - Multiple categorical values (array)
- `link` - URLs
