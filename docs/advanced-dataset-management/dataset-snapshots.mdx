...
<Frame>
  <img src="/images/snapshot-catalog.png" alt="Snapshot Catalog drawer showing list of saved snapshots" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-options.png" alt="Snapshot three-dot menu showing Edit, Clone, Copy Snapshot ID, Restore, and Remove options" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-create-dialog.png" alt="Create Snapshot dialog with name and description fields" />
</Frame>
...
Restore a snapshot to revert the dataset to a previously saved state. All changes made since that snapshot — including media additions, enrichment, metadata updates, and tag changes — are replaced with the snapshot's data. Restoration is available for any snapshot except the one marked as **Current Version**.
...
<Frame>
  <img src="/images/snapshot-restore-confirm.png" alt="Restore Snapshot confirmation dialog" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-clone-confirm.png" alt="Clone Snapshot confirmation dialog" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-update-edit-details.png" alt="Update Snapshot dialog with name and description fields" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-remove-confirm.png" alt="Remove Snapshot confirmation dialog" />
</Frame>
...
The **Snapshot Catalog** allows restoration to any snapshot, whether it was created earlier or later than the current version. This enables movement both forward and backward through the dataset's history — restoring to an older checkpoint or advancing to a more recent one.
