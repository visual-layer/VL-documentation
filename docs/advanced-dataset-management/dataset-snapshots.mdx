...
<Frame>
  <img src="/images/snapshot-options.png" alt="Snapshot three-dot menu showing Edit, Clone, Copy Snapshot ID, Restore, and Remove options" className="img-sm" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-create-dialog.png" alt="Create Snapshot dialog with name and description fields" className="img-sm" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-restore-confirm.png" alt="Restore Snapshot confirmation dialog" className="img-sm" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-clone-confirm.png" alt="Clone Snapshot confirmation dialog" className="img-sm" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-update-edit-details.png" alt="Update Snapshot dialog with name and description fields" className="img-sm" />
</Frame>
...
<Frame>
  <img src="/images/snapshot-remove-confirm.png" alt="Remove Snapshot confirmation dialog" className="img-sm" />
</Frame>
