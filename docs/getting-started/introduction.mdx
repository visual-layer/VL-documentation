...
**Chrome browser is recommended** for the best Visual Layer experience. While other browsers like Firefox may work for basic functionality, they are not fully supported and may have compatibility issues with advanced features.
