...
A visual file (e.g., PNG, JPG, JPEG, GIF, TIFF, HEIC, BMP, WEBP) representing an object or scene. It can be an artifact, such as a photograph or other two-dimensional picture, that resembles a subject.
...
A media file (e.g., MP4, AVI, MOV, MKV, WEBM, MPG, MPEG) containing a sequence of moving images. Videos are treated as datasets and can be analyzed frame-by-frame.
