...
<Note>
  For more information about self-hosting, see [Self-hosting System Requirements](/docs/self-hosting/System_requirements).
</Note>

## Deployment

Visual Layer supports multiple deployment methods, including public cloud, private cloud, and airgapped on-premises (self-hosting) environments.
