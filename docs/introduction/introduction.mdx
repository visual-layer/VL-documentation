...
## What makes Visual Layer efficient for visual data management
...
<CardGroup cols={2}>
  <Card title="Tutorial: Create" icon="graduation-cap" href="/docs/quick-start/tutorial-create-dataset">
    Upload and index your first visual dataset
  </Card>
  <Card title="Tutorial: Explore" icon="graduation-cap" href="/docs/quick-start/tutorial-explore-dataset">
