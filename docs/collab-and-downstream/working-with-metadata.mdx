---
title: "Export Data"
description: "Extract, parse, and analyze metadata.json files exported from Visual Layer using the API and Python workflows."
---


Use the export options to download either the full dataset or a filtered subset.
...
For more information on exporting datasets, see our [Export Dataset guide](/docs/advanced-dataset-management/export-dataset).