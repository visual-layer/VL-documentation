---
title: "🔵Outliers"
slug: "outlier-imagesobjects-copy-1"
excerpt: ""
hidden: true
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d7dd161-image.png",
        null,
        "Coco Dataset: Top bar Issues filter: Select \"Outliers\""
      ],
      "align": "center",
      "border": true,
      "caption": "Coco Dataset: Top bar Issues filter: Select \"Outliers\""
    }
  ]
}
[/block]
...
4. The returned results will consists of images or image clusters, object or object clusters that are detected by Visual Layer as outliers. 
