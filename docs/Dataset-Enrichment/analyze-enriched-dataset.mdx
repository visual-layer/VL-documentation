...
Use [Semantic Search](/docs/Exploring-datasets/semantic-search) to explore your dataset using **natural language queries**.
...
- [Mislabels](/docs/Exploring-datasets/mislabeled-imagesobjects)
- [Duplicates](/docs/Exploring-datasets/duplicate-imagesobjects)
- [Outliers](/docs/Exploring-datasets/outlier-imagesobjects)
- [Unlabeled Items](/docs/Exploring-datasets/unlabeled-data-detection)
