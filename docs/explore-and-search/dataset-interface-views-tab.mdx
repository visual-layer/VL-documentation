...
- Text and [semantic search](/docs/explore-and-search/using-search-filter#semantic-search-natural-language) queries
- VQL (Visual Query Language) filters
- [Label](/docs/advanced-dataset-management/importing-annotations) and [user tag](/docs/advanced-features/tag-iteams) selections
- [Quality issue](/docs/explore-and-search/using-search-filter#quality--confidence-thresholds) filters (duplicates, outliers, mislabels)
- Entity type (images, objects, or video frames)
- [Similarity](/docs/explore-and-search/visual-search) thresholds
- [Metadata](/docs/advanced-features/custom-metadata) source filters
- Folder path filters
