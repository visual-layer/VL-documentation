...
- **Image tagging** — assigns labels to the entire image. Populates the **Labels** panel in the [Details Sidebar](/docs/explore-and-search/dataset-interface-explore-tab#details-sidebar).
