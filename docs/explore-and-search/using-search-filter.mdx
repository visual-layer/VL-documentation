---
title: Using Search and Filter Tools
description: A complete guide to the Visual Layer interface, workflows, and available options for searching and filtering data.
sidebarTitle: Search & Filter Referemce
---
...
3.  Apply to see images that have valid labels but do not visually match the standard appearance of their class.
