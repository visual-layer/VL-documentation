...
To access **VL Chat**, open any dataset in Visual Layer and click <img src="/images/start-vl-chat.png" alt="VL Chat button" className="img-marker" /> in the top navigation bar. The chat interface appears as a panel on the right side of your screen, allowing you to explore while viewing your dataset.
