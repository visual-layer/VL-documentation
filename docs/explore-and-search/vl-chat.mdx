...
To access VL Chat, open any dataset in Visual Layer and click the **Ask VL** button in the top navigation bar.

<Frame>
  <img src="/images/start-vl-chat.png" alt="Ask VL button" style={{ width: '20%' }} />
</Frame>

The chat interface appears as a panel on the right side of your screen, allowing you to explore while viewing your dataset.
