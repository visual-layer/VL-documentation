...
- **`defaults.json`** — Built-in defaults (do not edit).
- **[`config.json`](#configuration-file-configjson)** — Your custom configuration.
- **[Environment variables](#environment-file-env)** — Override any JSON setting.
