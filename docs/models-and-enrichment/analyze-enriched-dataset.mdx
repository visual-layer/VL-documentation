...
Use [Caption Search](/docs/explore-and-search/using-filters) to filter and organize your enriched data more effectively.

---

## Export Enriched Data

Use the [Export tool](/docs/advanced-dataset-management/export-dataset) to download either the full dataset or a filtered subset.
