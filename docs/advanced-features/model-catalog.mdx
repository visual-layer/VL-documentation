...
To access the **Model Catalog**, click the Model Catalog icon ![](/images/vl-modelcatalog-icon.png) from the left **Navigation Panel**. The **Model Catalog** loads, displaying all your trained models.
...
**To mark a model as production-ready**, check the **Production** checkbox for the relevant model. The model is marked as production, making it easy to filter and identify deployment-ready models.
...
2. Click **Yes** to confirm the removal (or **Cancel** to keep the production status). The model is unmarked as production.
...
**To view training results**, click the results icon ![](/images/vl-modelcatalog-view-results.png) in the **Results** column. The training results report opens embedded within Visual Layer, displaying:
...
3. Click **Yes, delete** to confirm (or **Cancel** to stop). The model entry is immediately removed from the catalog interface.
