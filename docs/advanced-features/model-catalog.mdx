...
To access the **Model Catalog**, click the Model Catalog icon ![](/images/modelcatalog-icon.png) from the left **Navigation Panel**. The **Model Catalog** loads, displaying all your trained models.

<Frame>
  <img src="/images/training-model-catalog.png" alt="Model Catalog Interface" />
</Frame>
...
<Frame>
  <img src="/images/modelcatalog-production-remove-confirmation.png" alt="Remove from Production Confirmation" />
</Frame>
...
**To view training results**, click the results icon ![](/images/modelcatalog-view-results.png) in the **Results** column. The training results report opens embedded within Visual Layer, displaying:
...
<Frame>
  <img src="/images/modelcatalog-deletemodel-confirmation.png" alt="Delete Model Confirmation" />
</Frame>
