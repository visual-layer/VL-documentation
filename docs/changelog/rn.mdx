...
### Add support for glTF 2.0 format (VL-4567)
...
### Improve rendering performance of large scenes (VL-4568)
...
### Fix memory leak in texture caching (VL-4569)
...
# Visual Layer Release Notes: 2024-08-15

## New Features

### [VL-3842] Add Support for Custom Fonts
...
### [VL-4123] Improve Rendering Performance of Large Datasets
...
### [VL-4215] Correct Header Component Alignment on Mobile
