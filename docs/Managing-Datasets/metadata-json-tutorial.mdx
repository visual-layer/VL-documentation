---
title: "Working with Exported Metadata.json Files"
description: "Learn how to extract, parse, and analyze Visual Layer's exported metadata.json files to gain insights from your datasets."
---

# Working with Exported Metadata.json Files
...
Now that you know how to work with exported metadata.json files, you can:
