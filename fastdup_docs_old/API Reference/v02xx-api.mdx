---
title: "V0.2xx API"
description: "This page holds the API reference for fastdup V0."
---
<a id="fastdup"></a>
...
- `Note` - fastdup plus beta version now supports bounding boxes on the c++ side. To use it prepare an input file with the following csv header: filename,col_x,row_y,width,height where each row as an image file  
  ...
  for our free beta program at [https://visual-layer.com](https://visual-layer.com) or send an email to [info@databasevisual.com](mailto:info@databasevisual.com).
...
- `bounding_box` _str_ - Optional bounding box to crop images, given as bounding_box='row_y=xx,col_x=xx,height=xx,width=xx'. This defines a global bounding box to be used for all images.  
  Beta release features (need to sign up at [https://visual-layer.com](https://visual-layer.com)): Tt is possible to set bounding_box='face' to crop the face from the image (in case a face is present).  
...
see [https://theailearner.com/2021/10/30/blur-detection-using-the-variance-of-the-laplacian-method/](https://theailearner.com/2021/10/30/blur-detection-using-the-variance-of-the-laplacian-method/).  
