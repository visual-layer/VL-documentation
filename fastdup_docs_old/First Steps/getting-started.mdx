...
This tutorial shows you how to use fastdup's core functions to analyze an image collection. By the end, you'll learn how to find:
...
If you're new to fastdup, start here.
...
Or if you're feeling adventurous, feel free to install on your machine and proceed. For a detailed list of installation options and supported platforms, see the [installation guide](/fastdup_docs_old/First%20Steps/installation).
