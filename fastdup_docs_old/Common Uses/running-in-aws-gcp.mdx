...
Full example notebook is here: [https://www.kaggle.com/code/graphlab/fastdup-coco-format-tutorial](https://www.kaggle.com/code/graphlab/fastdup-coco-format-tutorial)
