---
title: "YOLOv5 Object Detection Video Analysis"
excerpt: "In this tutorial, we will use fastdup with a pretrained yolov5 object detection model to detect and crop from videos. Following that we analyze the cropped objects for issues such as duplicates, near-duplicates, outliers, bright/dark/blurry objects."
hidden: false
metadata: 
  image: []
  robots: "index"
createdAt: "Mon Apr 03 2023 05:55:37 GMT+0000 (Coordinated Universal Time)"
