...
> 👍 Purpose
> 
> This notebook shows how to enrich your image dataset using labels generated with open-source zero-shot image classification (or image tagging) models such as [Recognize Anything](https://github.com/xinyu1205/recognize-anything) (RAM) and [Tag2Text](https://github.com/xinyu1205/recognize-anything).
> 
...
Within fastdup you can readily use the zero-shot image tagging models such as [Recognize Anything Model (RAM)](https://github.com/xinyu1205/recognize-anything) and [Tag2Text](https://github.com/xinyu1205/recognize-anything). Both Tag2Text and RAM exhibit strong recognition ability.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7b1a365-plot_0.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3dcbd20-plot_1.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b7d8cb4-plot_2.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/df0aace-plot_3.png",
        "",
        ""
      ],
      "align": "center"
...
> 👍 Next Up
> 
> Try out the [Google Colab](https://colab.research.google.com/github/visual-layer/fastdup/blob/main/examples/enrichment-zero-shot-classification.ipynb) and [Kaggle](https://kaggle.com/kernels/welcome?src=https://github.com/visual-layer/fastdup/blob/main/examples/enrichment-zero-shot-classification.ipynb) notebook to reproduce this example.
> 
> Also, check out [Part 2](doc:enrichment-zero-shot-detection) of the series where we explore how to generate bounding boxes from the tags using zero-shot detection models like Grounding DINO. See you there!
