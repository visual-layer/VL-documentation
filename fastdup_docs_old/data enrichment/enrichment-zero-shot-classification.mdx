...
description: "Enrich your visual data with zero-shot image classification and tagging models such as Recognize Anything, Tag2Text and more."
---
...
> 
> Also, check out [Part 2](#enrichment-zero-shot-detection) of the series where we explore how to generate bounding boxes from the tags using zero-shot detection models like Grounding DINO. See you there!
