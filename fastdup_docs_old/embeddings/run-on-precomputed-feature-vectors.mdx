...
description: "If you have existing feature vectors, you can run fastdup over the feature vectors to analyze for issues."
---
...
> 👍 Tip
> 
> Read more on how to tune the run parameters to obtain a desired output on your dataset [here](#tuning-run-parameters).
