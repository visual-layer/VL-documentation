---
title: "Run fastdup on TIMM Embeddings"
excerpt: "Compute your embeddings using TIMM and run fastdup over the embeddings to analyze for issues."
hidden: false
metadata: 
  image: []
  robots: "index"
createdAt: "Mon Oct 16 2023 05:11:50 GMT+0000 (Coordinated Universal Time)"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/09f6849-download.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c16d79c-_media_dnth_Active-Projects_fastdup_examples_work_dir_galleries_components.html.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/28ab80b-_media_dnth_Active-Projects_fastdup_examples_work_dir_galleries_duplicates.html.png",
        "",
        ""
      ],
      "align": "center"
