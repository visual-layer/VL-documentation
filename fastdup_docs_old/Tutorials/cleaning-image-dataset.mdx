...
description: "This tutorial shows how to clean an image collection or dataset from the issues found with fastdup."
---
...
Additional reading: [remove_duplicates](/fastdup_docs_old/API%20Reference/v02xx-api#remove_duplicates)
