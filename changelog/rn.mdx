...
## New Features & Enhancements: New Embedding Model
...
- Raises the overall trustworthiness of datasets through improved quality checks

### Textual Search Without GPUs

Until now, running rich text-based searches across large datasets often required specialized hardware such as GPUs. With this release, our model delivers efficient, accurate textual search on standard CPUs—making it easier and more cost-effective to integrate into everyday workflows.
