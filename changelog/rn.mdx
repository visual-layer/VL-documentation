...
### TinyCLIP Base Embedding Model

Visual Layer now includes TinyCLIP, our new base embedding model that delivers more accurate visual similarity search and enhanced clustering capabilities.
...
[Learn more about TinyCLIP](/docs/Dataset-Enrichment/tinyclip-model)
...
### Enhanced Dataset Creation Validation

Improved validation system provides better feedback during dataset creation and upload processes.
...
### Expanded Custom Metadata Support

Custom metadata enum values limit increased from 20 to 100 values per field.

**Benefits:**
- Support for more complex categorization schemes
- Greater flexibility in metadata organization
- Better alignment with enterprise data structures

## Fixed Issues

- Duplicates filter now available when performing visual search by uploading external images
