...
## New Features: New Embedding Model
...
- Duplicates filter availablity issues after performing a visual search by uploading an external image
...
<Update label="2025-08-06" version="2.43.0">
## New Features: New filter: Filter by object size (width, height)
...
Show only objects with area > or < [____] px²
