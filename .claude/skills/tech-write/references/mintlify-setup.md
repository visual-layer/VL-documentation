...
This installs the Mintlify CLI globally, making it accessible from any directory.
...
This confirms that the CLI is installed correctly and accessible from your terminal.

### Using the Mintlify CLI in Your Workflow

#### Preview Documentation Locally

1. Navigate to your project directory (the directory containing the `docs.json` file).
2. Run the development server:
     ```bash
     mintlify dev
     ```
3. Open your browser and navigate to `http://localhost:3000` to view your documentation.

#### Customize the Development Server Port

If port 3000 is in use or you need a different port:
