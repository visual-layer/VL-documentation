...
{/* ── Capabilities ── */}
<div className="vl-landing-search-row">
  <div className="vl-landing-search" onClick={() => { document.dispatchEvent(new KeyboardEvent('keydown', { key: 'k', metaKey: true })); }}>
    <svg className="vl-landing-search-icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
    <span className="vl-landing-search-text">Search documentation...</span>
    <span className="vl-landing-search-shortcut">⌘K</span>
  </div>
</div>
